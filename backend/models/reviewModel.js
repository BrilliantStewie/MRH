...
const reviewChatSchema = new mongoose.Schema({
  ...
  editHistory: [{ message: { type: String, trim: true }, editedAt: { type: Date, default: Date.now } }]
}, { _id: true });
...
const reviewSchema = new mongoose.Schema({
  ...
  editHistory: [{ rating: { type: Number }, comment: { type: String, trim: true }, editedAt: { type: Date, default: Date.now } }]
}, { timestamps: true });
