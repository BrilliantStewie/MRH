...
const StaffSidebar = () => {
  const baseStyle =
    "flex items-center gap-4 px-6 py-4 text-[13px] font-bold uppercase tracking-wider text-slate-500 transition-all border-r-4 border-transparent hover:bg-emerald-50/50 hover:text-emerald-700 group";
